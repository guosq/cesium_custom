...
define(['./Matrix2-70d3547e', './AxisAlignedBoundingBox-0cbc6f42', './Transforms-f37c129d', './when-6655f883', './RuntimeError-5f205b85', './TerrainEncoding-98abf502', './ComponentDatatype-579b2047', './OrientedBoundingBox-cdc2f0bf', './WebMercatorProjection-b5f86a40', './createTaskProcessorWorker', './combine-1fd4d5cd', './AttributeCompression-f5ecc6e8', './WebGLConstants-cf1206a6', './EllipsoidTangentPlane-23094563', './IntersectionTests-af7b4fec', './Plane-b8f2179f'], (function (Matrix2, AxisAlignedBoundingBox, Transforms, when, RuntimeError, TerrainEncoding, ComponentDatatype, OrientedBoundingBox, WebMercatorProjection, createTaskProcessorWorker, combine, AttributeCompression, WebGLConstants, EllipsoidTangentPlane, IntersectionTests, Plane) { 'use strict';
